...
import { ExtractJwt, JwtConfigUndefinedException, JwtFallbackConfigUndefinedException } from '../jwt/index';

// Import constants
import { AUTHENTICATION_MODULE_OPTIONS_DEFAULT_SETTINGS_TOKEN, AUTHENTICATION_MODULE_SETTINGS_TOKEN } from '../core/authentication.constants';
...
export const authenticationDefaultConfig = registerAs(
  ...
  (): AuthenticationSettingsInterface => authenticationOptionsDefaultConfig().authentication,
);
...
export const authRefreshDefaultConfig = registerAs(
  ...
  (): AuthRefreshSettingsInterface => authenticationOptionsDefaultConfig().refresh,
); 