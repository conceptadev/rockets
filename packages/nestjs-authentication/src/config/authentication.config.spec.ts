...
import { authenticationConfig, AuthenticationConfigFactory, AUTHENTICATION_MODULE_CONFIG_TOKEN, CREDENTIAL_LOOKUP_SERVICE_TOKEN } from './authentication.config';
...
describe('authentication configuration', () => {
  ...
  describe('options token', () => {
    it('should be defined', async () => {
      ...
      expect(CREDENTIAL_LOOKUP_SERVICE_TOKEN).toEqual('CREDENTIAL_LOOKUP_SERVICE');
    });
  });
