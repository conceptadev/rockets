import { AssignmentNotFoundException } from "./assignment-not-found.exception";

describe('AssignmentNotFoundException', () => {
  it('should create an instance with default message', () => {
    const assignmentName = 'testAssignment';
    const exception = new AssignmentNotFoundException(assignmentName);
  ...
  it('should create an instance with custom message', () => {
    ...
    const exception = new AssignmentNotFoundException(
      assignmentName,
      customMessage,
    );
