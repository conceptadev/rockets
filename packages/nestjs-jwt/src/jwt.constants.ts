 ...
 */
export const JWT_MODULE_JWT_SERVICE_ACCESS_TOKEN =
  'ROCKTS_JWT_MODULE_JWT_SERVICE_ACCESS_TOKEN';

/**
 * The token to which the jwt service (for refresh) is set.
 */
export const JWT_MODULE_JWT_SERVICE_REFRESH_TOKEN =
  'ROCKTS_JWT_MODULE_JWT_SERVICE_REFRESH_TOKEN';
