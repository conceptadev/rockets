# @conceptadev/rockets-repository-typeorm

[![NPM](https://img.shields.io/npm/v/@conceptadev/rockets-repository-typeorm)](https://www.npmjs.com/package/@conceptadev/rockets-repository-typeorm)
...
on a single `@conceptadev/*` package instead of reaching for the upstream one
...
```bash
npm install @conceptadev/rockets-repository-typeorm typeorm
```
...
Bridges the ORM-free zod layer (`@conceptadev/rockets-core/zod`) to concrete
