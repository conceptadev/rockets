 ...
 */
exports.AccessControlUpdateOne = (resource, paramFilter) => {
    const acFilter = access_control_grant_decorator_1.AccessControlGrant({
        resource: resource,
        action: access_control_action_enum_1.AccessControlAction.UPDATE,
    });
    if (paramFilter) {
...
//# sourceMappingURL=access-control-update-one.decorator.js.map