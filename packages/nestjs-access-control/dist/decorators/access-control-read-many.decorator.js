 ...
 */
exports.AccessControlReadMany = (resource, paramFilter) => {
    ...
    if (paramFilter) {
        return common_1.applyDecorators(acFilter, access_control_filter_decorator_1.AccessControlFilter({
            type: access_control_filter_type_enum_1.AccessControlFilterType.QUERY,
            filter: paramFilter,
        }));
    }
    else {
...
//# sourceMappingURL=access-control-read-many.decorator.js.map