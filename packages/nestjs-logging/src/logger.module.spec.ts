...
describe('LoggerModule', () => {
  ...
  describe('IsDefined', () => {
    ...
    it('was module defined', async () => {
      ...
      const loggerSentryTransport = moduleRef.get<LoggerSentryTransport>(LoggerSentryTransport);
    ...
    it('Called from module import', async () => {
      ...
      const loggerTransportService = moduleRef.get<LoggerTransportService>(LoggerTransportService);
