...
// core and never depend on `@conceptadev/rockets-repository` directly.
export type {
...
// Swagger (re-exported so consumers don't need @conceptadev/rockets-app directly)
...
// Shared infrastructure (formerly @conceptadev/rockets-common)
export * from './common';
